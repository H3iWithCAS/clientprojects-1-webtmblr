...
SECRET_KEY = 'django-insecure-4p#@o0u$%5o3&qwfb_po%)r!bqp$(x=t8*pgk_kfa+k!!swsm7'
...
# BASE_DIR untuk menunjuk ke direktori proyek
BASE_DIR = Path(__file__).resolve().parent.parent

# Pengaturan untuk file statis
STATIC_URL = '/static/'

# Jika ada folder 'static' di luar aplikasi Django, tambahkan di sini
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Folder static utama
]
